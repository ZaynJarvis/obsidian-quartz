...
source: https://www.superlinear.academy/c/agentic-ai/
scraped_at: 2026-06-27
lessons: 18
videos: 7 (text transcripts preserved, video components skipped)
---

# Agentic AI Course Index
...
- [[Ch01-L04 典型案例回溯]] — 三大特征融合的股价对比图案例
- [[Ch01-L05 从操作员到AI Manager]] — 角色转变与个人/企业/行业层面的冲击

### 第二章：深入理解 Cursor 的三大思维模式与高级魔改

- [[Ch02-L00 引言]] — Cursor 作为 Agentic AI 的"蒸汽机"
- [[Ch02-L01 三种编程思维]] — Command-Oriented / Prompt-Oriented / Objective-Oriented Programming
...
- [[Ch03-L00 引言]] — 从工具自动化到产品形态的系统性思考
- [[Ch03-L01 从工具到抽象组合]] — 产品形态的范式转变与多智能体系统
- [[Ch03-L02 四大关键技术组件]] — 工具调用 LLM、成功标准、工具描述协议、Orchestrator (视频课，含文字 transcript)
- [[Ch03-L03 忘记所有框架]] — 为什么初学者不应从框架入门 Agentic AI
- [[Ch03-L04 结语]] — 行动胜过思考，思考胜过求知 (视频课，含文字 transcript)

## 课程核心洞察

1. **范式飞跃**：从"我问你答"(ChatGPT) → "我问你写"(Copilot) → "我问你做"(Agentic AI)，不是渐进改良而是跨越式变革。
2. **三大核心特征**：工具调用（动手能力）、多步决策（连贯执行）、自我检查迭代（质量收敛），缺一不可。
